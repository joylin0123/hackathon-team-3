...
export function SpeedGauge() {
  ...
  return (
    <div className="bg-white/5 rounded-lg p-3 flex flex-col items-center justify-center min-h-0">
      <div className="text-[#35fdad] text-xs font-mono uppercase tracking-widest mb-1">Live Speed</div>
      <div className="text-5xl font-bold tabular-nums leading-none">{speed.toFixed(0)}</div>
